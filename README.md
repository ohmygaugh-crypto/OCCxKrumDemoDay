Just a obsidian plugin that exports a canvas to html along with the selected directorys and files that are called to render within the canvas viewport
